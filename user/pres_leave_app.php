...
if(isset($_SESSION['ID']))
			{
				...
				$sql = "select * from leave_status where faculty_id = '".$faculty_id."'";						
				$result = $conn->query($sql);
				
				$sql_past = "select * from previous_leave_app where faculty_id_wants_leave = '".$faculty_id."' order by date_of_leave";						
