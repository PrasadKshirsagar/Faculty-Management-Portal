    ...
    <?php
       ...
       if( $result!=NULL && $result->num_rows > 0 ) {
            ...
            while( $row = $result->fetch_assoc() ) {
                ...
                echo "<td><form action = 'calc_faculty_payslip.php' method='POST'>
				...
				<input type='text' name=month style='background-color:black;' placeholder='enter month' >
				<input type='text' name=year style='background-color:black;' placeholder='enter year' >
